!(function (e, t, n) {
    ...
    function b(e, t) {
        a(e, t, { "selectstart dragstart mousedown": C }), e.css({ MozUserSelect: "none", msUserSelect: "none", webkitUserSelect: "none", userSelect: "none" });
    }
    function y(e, t, n) {
        var s = e.val();
    ...
    function g(e, t) {
        var n;
        (n = e.parents()).push(e[0]), w((n = n.not(":visible")), { visibility: "hidden", display: "block", position: "absolute" }, t);
    }
    function k(e, t) {
        return function () {
        ...
        A = [
            ...
            },
            {
                ...
                apply: function (e, n) {
                    ...
                    var u, f, p, m;
                    return (
                        (u = d(e, n, { divClass: n.fileClass, spanClass: n.fileButtonClass, spanHtml: n.fileButtonHtml, spanWrap: "after" })),
                        (f = u.div),
                        (m = u.span),
                        (p = t("<span />").html(n.fileDefaultHtml)).addClass(n.filenameClass),
                        (p = c(e, p, "after")),
            ...
            //},
            {
                ...
                apply: function (e, n) {
                    ...
                    return (
                        ...
                        n.selectAutoWidth
                            ? g(e, function () {
                                w(t([u[0], l[0]]), { display: "block" }, function () {
                                    var e;
                ...
                x
                    ? (n.resetSelector &&
                        ...
                        this.each(function () {
                            ...
                            for (e = 0; e < A.length; e += 1) if ((s = A[e]).match(i, n)) return (a = s.apply(i, n)), i.data("uniformed", a), void t.uniform.elements.push(i.get(0));
                        }))
                    : this
            );
        }),
        (t.uniform.restore = t.fn.uniform.restore = function (e) {
            void 0 === e && (e = t.uniform.elements),
                t(e).each(function () {
                    var e,
                        n,
                        s = t(this);
